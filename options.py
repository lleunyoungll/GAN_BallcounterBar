...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--save_weight_freq', type=int, default=1, help='frequency of saving weight file (.pth)')
        ...
        self.parser.add_argument('--niter', type=int, default=100000, help='number of epochs to train for')
        ...
        self.parser.add_argument('--testOnefilepath', type=str, default="", help='If Test Only One file and save result to ./testResultOneFiles folder using ./savedWeights pth model files')
        self.isTrain = True
        self.opt = None
